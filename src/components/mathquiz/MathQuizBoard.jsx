      ...
      <div className="flex flex-col gap-0.5 min-w-0 flex-1">
        ...
        {!correct && (
          <p style={{ fontSize: '0.75rem', color: 'var(--label-tertiary)' }}>
            ...
            {' · '}Correct:{' '}
            <span style={{ color: '#1a7a35', fontWeight: 600 }}>
              {problem.answer}
            </span>
          </p>
        )}
...
function Game({ problems, onNewGame }) {
  ...
  const handleSubmit = () => {
    ...
    setRecords((prev) => [
      ...prev,
      { userAnswer: input.trim(), timeTaken: elapsed },
    ])
      ...
      <div className="flex flex-col items-center gap-6 w-full max-w-lg mx-auto px-4 sm:px-6 pt-6 pb-12">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            >
              You scored{' '}
              <span style={{ color: 'var(--label-primary)', fontWeight: 700 }}>
                {score}
              </span>{' '}
              out of{' '}
              <span style={{ color: 'var(--label-primary)', fontWeight: 700 }}>
          ...
          >
            ...
            >
              ...
              <circle
                ...
                style={{
                  transition:
                    'stroke-dashoffset 1s cubic-bezier(0.34,1.2,0.64,1)',
                }}
              />
            </svg>
            <span
  ...
  return (
    <div className="flex flex-col items-center gap-5 w-full max-w-lg mx-auto px-4 sm:px-6 pt-6 pb-12">
      ...
      <div
        className={clsx(
          'w-full rounded-3xl p-6 flex flex-col gap-5',
          shaking && 'wordle-shake'
        )}
        style={{
          background: cardBg,
      ...
      {!answered && (
        ...
        >
          Type your answer and press <strong>Submit</strong> or hit{' '}
          <strong>Enter</strong>.
        </p>
      )}
    </div>
